        ...
        <form>
                <div className="row mb-3">
                    ...
                    <div className="col-sm-10">
                        <input type="text" className="form-control" name="firstName" onChange={adminForm} />
            ...
            <div className="row mb-3">
                ...
                <div className="col-sm-10">
                    <input type="text" className="form-control" name="lastName" onChange={adminForm}/>
            ...
            <div className="row mb-3">
                ...
                <div className="col-sm-10">
                    <input type="text" className="form-control" name="email" onChange={adminForm}/>
